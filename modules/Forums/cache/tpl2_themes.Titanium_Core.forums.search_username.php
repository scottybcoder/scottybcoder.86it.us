...
// eXtreme Styles mod cache. Generated on Mon, 07 Nov 2022 09:34:18 +0000 (time=1667813658)
...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
    <tr>
        <td><table width="100%" class="forumline" cellpadding="4" cellspacing="1" border="0">
            ...
            <tr> 
                <td valign="top" class="row1"><span class="genmed"><br /><input type="text" name="search_username" value="<?php echo isset($this->vars['USERNAME']) ? $this->vars['USERNAME'] : $this->lang('USERNAME'); ?>" class="post" />&nbsp; <input type="submit" name="search" value="<?php echo isset($this->vars['L_SEARCH']) ? $this->vars['L_SEARCH'] : $this->lang('L_SEARCH'); ?>" class="titaniumbutton" /></span><br /><span class="gensmall"><?php echo isset($this->vars['L_SEARCH_EXPLAIN']) ? $this->vars['L_SEARCH_EXPLAIN'] : $this->lang('L_SEARCH_EXPLAIN'); ?></span><br />
                <?php
